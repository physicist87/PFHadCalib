# /users/kirschen/CMSSW_740_pre9/HCALMethods_TestConfig_pre9/V2 (CMSSW_7_4_0_pre9)

import FWCore.ParameterSet.Config as cms

process = cms.Process( "TEST" )
#process.load("setup_cff")
process.load("PFHadCalib.PFHadHLT.setup_cff")


process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/kirschen/CMSSW_740_pre9/HCALMethods_TestConfig_pre9/V2')
)
...
process.hltOutputA = cms.OutputModule( "PoolOutputModule",
    ...
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'HLT_PFJetDummy_Stripped' ) ),
...
#      'keep *_hltParticleFlow__*',
#      'keep *_hltTowerMakerForPF__*',
...
process.HLT_PFJetDummy_Stripped = cms.Path( process.HLTBeginSequence + process.hltPrePFJetDummyStripped + process.HLTAK4CaloJetsSequence + process.HLTAK4PFJetsSequence + 
process.genParticlesForJetsNoNu + process.ak4GenJetsNoNu + 
process.genParticlesForJets + process.ak4GenJets + 
process.HLTEndSequence )
process.HLT_PFMETDummy_Stripped = cms.Path( process.HLTBeginSequence + process.hltPrePFMETDummyStripped + process.HLTRecoMETSequence + process.HLTAK4CaloJetsSequence + process.HLTAK4PFJetsSequence + process.hltPFMETProducer + process.HLTEndSequence )


process.HLTSchedule = cms.Schedule( *(process.HLT_PFJetDummy_Stripped, process.HLT_PFMETDummy_Stripped ))
