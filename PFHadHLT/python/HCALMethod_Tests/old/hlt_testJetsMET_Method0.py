# /users/kirschen/CMSSW_740_pre7_HLT1/HCALMethods_TestConfig/V2 (CMSSW_7_4_0_pre7_HLT1)
...
#process.load("setupOLD72_cff")

process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/kirschen/CMSSW_740_pre7_HLT1/HCALMethods_TestConfig/V2')
)
...
process.hltOutputA = cms.OutputModule( "PoolOutputModule",
    ...
    SelectEvents = cms.untracked.PSet(  SelectEvents = cms.vstring( 'HLT_PFJetDummy_Stripped_' ) ),
...
process.HLT_PFJetDummy_Stripped_ = cms.Path( process.HLTBeginSequence + process.hltPrePFJetDummyStripped + process.HLTAK4CaloJetsSequence + process.HLTAK4PFJetsSequence + 
#process.genParticlesForJetsNoNu + process.ak4GenJetsNoNu + 
process.HLTEndSequence )
process.HLT_PFMETDummy_Stripped = cms.Path( process.HLTBeginSequence + process.HLTRecoMETSequence + process.HLTAK4CaloJetsSequence + process.HLTAK4PFJetsSequence + process.hltPFMETProducer + process.HLTEndSequence )
